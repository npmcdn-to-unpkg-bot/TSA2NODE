			...
			if (rootTraversed || dir !== inputDir) {
				...
				if (pJsonFile) {
					...
					if (!pjson.nativescript) {
						// if (pjson.src-nativescript.sbgShouldNotVisit && pjson.src-nativescript.platforms) {
						// 	return;
						// }
...
/*
*	Visist's the passed AST with a given visitor and extracts src-nativescript speciffic data.
